	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.php"><img src="images/104006040_3018053541645060_4750639676057697116_n.jpg" width="300px" heght="150px"></h1></a></div>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 breadcrumbs text-center">
						<h3>Cafe Sách</h3>
						<p><span><a href="index.html">Home</a></span> / <span>Cafe Sách </span></p>
						<div class="col-md-3">
						<div class="sidebar">
							<div class="side">
                ...
                <input type="text" name="search" class="form-control" id="search" placeholder="Enter any key to search...">
		...
		<div id="colorlib-container">
			<div class="container">
				...
				$sql = "
					SELECT *
					FROM tbl_cafe_sach Order by id_cafe_sach DESC LIMIT 0,6
					";
			...
			;?>
							<div class="col-md-6">
								<div class="blog-entry">
									...
									<div class="blog-img">
										<a href="./cafechitiet.php?id= <?php echo $row["id_cafe_sach"];?>" ><img src="./images/<?php 
						if ( $row ["anh"]<>"") {
							echo $row["anh"];
						} else {
							echo "no-image.png";
						}
						 ;?>" width=" 500" height=" 00px"  class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<h2><a href="./cafechitiet.php?id= <?php echo $row["id_cafe_sach"];?>"> <?php echo $row["tieu_de"];?></a></h2>
